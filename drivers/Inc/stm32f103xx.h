...
#define ROM_BASE_ADDR                                                          \
  0x1FFFF000U /* ROM base address where ROM bootloader is stored by ST */
...
typedef struct {
  volatile uint32_t
      CRL; /*Port configuration register low ,Address offset : 0x00*/
  volatile uint32_t
      CRH; /*Port configuration register high ,Address offset : 0x04*/
  ...
  volatile uint32_t
      LCKR; /*Port configuration lock register ,Address offset : 0x18*/
} GPIO_RegDef_s;
...
typedef struct {
  ...
  volatile uint32_t
      CFGR; /* Clock configuration register, Address offset : 0x04 */
  volatile uint32_t CIR; /* Clock interrupt register, Address offset : 0x08 */
  volatile uint32_t
      APB2RSTR; /* APB2 peripheral reset register, Address offset : 0x0C */
  volatile uint32_t
      APB1RSTR; /* APB1 peripheral reset register, Address offset : 0x10 */
  volatile uint32_t
      AHBENR; /* AHB peripheral clock enable register, Address offset : 0x14 */
  volatile uint32_t APB2ENR; /* APB2 peripheral clock enable register, Address
                                offset : 0x18 */
  volatile uint32_t APB1ENR; /* APB1 peripheral clock enable register, Address
                                offset : 0x1C */
  volatile uint32_t
